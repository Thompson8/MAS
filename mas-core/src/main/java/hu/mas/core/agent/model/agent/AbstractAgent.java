...
public abstract class AbstractAgent implements Runnable {
	...
	public AbstractAgent(Vehicle vehicle, Vertex from, Vertex to, MasController masController,
			SumoTraciConnection connection) {
		this(generateId(), vehicle, from, to, masController, connection);
	}

	public AbstractAgent(String id, Vehicle vehicle, Vertex from, Vertex to, MasController masController,
			SumoTraciConnection connection) {
		this.id = id;
